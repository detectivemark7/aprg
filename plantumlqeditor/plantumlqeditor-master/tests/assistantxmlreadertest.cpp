...
INSTANTIATE_TEST_CASE_P(
    ...
    ::testing::Values(
        ...
        ,
        (RemoveWhitespaceTestData){"\n\nfoo\nbar\n\n", "foo\nbar"}
        // empty lines at start and at end of the block are removed
        ,
        (RemoveWhitespaceTestData){"foo\n\n\nbar", "foo\n\n\nbar"}  // empty lines in the middle of the block are kept
        ,
        (RemoveWhitespaceTestData){"  foo\n    bar\n  baz", "foo\n  bar\nbaz"}
        // whitespace at the start of the line is removed, but identation is kept
        ,
        (RemoveWhitespaceTestData){"foo    \nbar ", "foo\nbar"}  // whitespace at the end of the line is removed
        ,
        (RemoveWhitespaceTestData){"\n\n\n  \n\t\t\n\n  foo  \n    bar   \n  baz   \n\n   \n", "foo\n  bar\nbaz"}
        // more whitespace on the right
        ));
