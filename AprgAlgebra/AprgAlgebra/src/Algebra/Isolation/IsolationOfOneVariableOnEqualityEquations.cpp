...
IsolationOfOneVariableOnEqualityEquations::IsolationOfOneVariableOnEqualityEquations(
        ...
        Term & termWithWithoutVariable) const
{
    ...
    segregateEquationsWithAndWithoutVariable(reducedEquations, variableName, equationsWithVariable, equationsWithoutVariable);
...
void IsolationOfOneVariableOnEqualityEquations::sortEquationsWithVariable(
        Equations & equationsWithVariable) const
{
    stable_sort(equationsWithVariable.begin(), equationsWithVariable.end(), [](
