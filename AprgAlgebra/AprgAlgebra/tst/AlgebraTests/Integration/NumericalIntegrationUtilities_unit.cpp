...
TEST(NumericalIntegrationUtilitiesTest, GetAnApproximateOfDefiniteIntegralUsingTrapezoidalRuleWorks) {
    ...
    EXPECT_EQ(
        ...
        getAnApproximateOfDefiniteIntegralUsingTrapezoidalRule(termToTest1, integralDetails, 200));
    EXPECT_EQ(
        Term(AlbaNumber::createFraction(186667, 640)),
        getAnApproximateOfDefiniteIntegralUsingTrapezoidalRule(termToTest2, integralDetails, 200));
    EXPECT_EQ(
        Term(2343.76171875), getAnApproximateOfDefiniteIntegralUsingTrapezoidalRule(termToTest3, integralDetails, 200));
}
...
TEST(NumericalIntegrationUtilitiesTest, GetAnApproximateOfDefiniteIntegralUsingSimpsonRuleWorks) {
    ...
    EXPECT_EQ(
        Term(AlbaNumber::createFraction(75, 2)),
        getAnApproximateOfDefiniteIntegralUsingSimpsonRule(termToTest1, integralDetails, 200));
    EXPECT_EQ(
        Term(AlbaNumber::createFraction(875, 3)),
        getAnApproximateOfDefiniteIntegralUsingSimpsonRule(termToTest2, integralDetails, 200));
    EXPECT_EQ(Term(2343.75), getAnApproximateOfDefiniteIntegralUsingSimpsonRule(termToTest3, integralDetails, 200));
    EXPECT_EQ(
        Term(19375.000000260424713),
        getAnApproximateOfDefiniteIntegralUsingSimpsonRule(termToTest4, integralDetails, 200));
}
...
TEST(NumericalIntegrationUtilitiesTest, GetActualTruncationErrorInTrapezoidalRuleWorks) {
    ...
    EXPECT_EQ(
        Term(AlbaNumber::createFraction(-1, 1920)),
        getActualTruncationErrorInTrapezoidalRule(termToTest2, integralDetails, 200));
...
TEST(NumericalIntegrationUtilitiesTest, GetActualTruncationErrorInSimpsonRuleWorks) {
    ...
    EXPECT_EQ(
        Term(-2.6042471290566027164e-07), getActualTruncationErrorInSimpsonRule(termToTest4, integralDetails, 200));
}
...
TEST(NumericalIntegrationUtilitiesTest, GetAnApproximateOfTruncationErrorInTrapezoidalRuleAtWorks) {
    ...
    EXPECT_EQ(
        Term(-0.0005208333333333334),
        getAnApproximateOfTruncationErrorInTrapezoidalRuleAt(termToTest2, integralDetails, 7.5, 0.025));
    EXPECT_EQ(
        Term(-0.01171875),
        getAnApproximateOfTruncationErrorInTrapezoidalRuleAt(termToTest3, integralDetails, 7.5, 0.025));
}
