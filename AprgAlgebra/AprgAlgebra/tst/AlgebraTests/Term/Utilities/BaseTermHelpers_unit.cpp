...
{
    BaseTermUniquePointer uniquePointerToVerify(createAUniquePointerFromTerm(Term(6415)));
...
{
    BaseTermUniquePointer uniquePointer(createAUniquePointerFromTerm(Term(6415)));
