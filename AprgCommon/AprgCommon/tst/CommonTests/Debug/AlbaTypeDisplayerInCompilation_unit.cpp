...
#define R_VALUE 0xA1BA // This will does not work: [int&& rValue=0xA1BA;]. A named variable will never be considered to be an rvalue even if it is declared as such.
...
/*TEST(AlbaTypeDisplayerInCompilationTest, DisplayTypeInTemplateByValueWorks)
{
    ...
    //displayTypeInTemplateByValue(intConstPointerConst); // TypeInTemplate is [const int*] and ParameterType is [const int*]
}*/
...
/*TEST(AlbaTypeDisplayerInCompilationTest, DisplayTypeInTemplateByReferenceWorks)
{
    ...
    //displayTypeInTemplateByReference(lValueConstReference); // TypeInTemplate is [const int] and ParameterType is [const int&]
...
/*TEST(AlbaTypeDisplayerInCompilationTest, DisplayTypeInTemplateByConstReferenceWorks)
{
    ...
    //displayTypeInTemplateByConstReference(lValueReference); // TypeInTemplate is [int] and ParameterType is [const int&]
    //displayTypeInTemplateByConstReference(lValueConstReference); // TypeInTemplate is [int] and ParameterType is [const int&]
...
/*TEST(AlbaTypeDisplayerInCompilationTest, DisplayTypeInTemplateByUniversalReferenceWorks)
{
    ...
    //displayTypeInTemplateByUniversalReference(lValueConst); // TypeInTemplate is [const int&] and ParameterType is [const int&]
    //displayTypeInTemplateByUniversalReference(lValueReference); // TypeInTemplate is [int &] and ParameterType is [int &]
    //displayTypeInTemplateByUniversalReference(lValueConstReference); // TypeInTemplate is [const int&] and ParameterType is [const int&]
...
/*TEST(AlbaTypeDisplayerInCompilationTest, DisplayTypeInTemplateByPointerWorks)
{
    ...
    //displayTypeInTemplateByPointer(intConstPointerConst); // TypeInTemplate is [const int] and ParameterType is [const int*]
}*/
...
/*TEST(AlbaTypeDisplayerInCompilationTest, DisplayThisTypeWorksUsingAutoByValue)
{
    ...
    DisplayThisType<decltype(autoWithLValueConstReference)> autoWithLValueConstReferenceToCheck; // ParameterType is [int]
    ...
    DisplayThisType<decltype(autoWithIntConstPointerConst)> autoWithIntConstPointerConstToCheck; // ParameterType is [const int*]
}*/
...
/*TEST(AlbaTypeDisplayerInCompilationTest, DisplayThisTypeWorksUsingAutoByReference)
{
    ...
    DisplayThisType<decltype(autoWithLValueReference)> autoWithLValueReferenceToCheck; // ParameterType is [int&]
    DisplayThisType<decltype(autoWithLValueConstReference)> autoWithLValueConstReferenceToCheck; // ParameterType is [const int&]
    DisplayThisType<decltype(autoWithRValue)> autoWithRValueToCheck; // ParameterType is [int&]
}*/
...
/*TEST(AlbaTypeDisplayerInCompilationTest, DisplayThisTypeWorksUsingAutoByValueWithBraceInitializer)
{
    ...
    DisplayThisType<decltype(autoWithMultipleInitialized)> autoWithMultipleInitializedToCheck; // ParameterType is [std::initializer<int>]
    DisplayThisType<decltype(autoWithOneAssigned)> autoWithOneAssignedToCheck; // ParameterType is [std::initializer<int>]
    DisplayThisType<decltype(autoWithMultipleAssigned)> autoWithMultipleAssignedToCheck; // ParameterType is [std::initializer<int>]
}*/
...
/*TEST(AlbaTypeDisplayerInCompilationTest, DisplayThisTypeWorksUsingDecltypeByName)
{
    ...
    DisplayThisType<decltype(lValueConstReference)> decltypeWithLValueConstReferenceToCheck; // ParameterType is [const int&]
    ...
    DisplayThisType<decltype(intConstPointerConst)> decltypeWithIntConstPointerConstToCheck; // ParameterType is [const int* const]
}*/
...
/*TEST(AlbaTypeDisplayerInCompilationTest, DisplayThisTypeWorksUsingDecltypeAuto)
{
    ...
    DisplayThisType<decltype(autoWithIntConstPointerConst)> autoWithIntConstPointerConstToCheck; // ParameterType is [const int* const]
}*/
...
/*TEST(AlbaTypeDisplayerInCompilationTest, DisplayThisTypeWorksUsingLambdaCaptureByValue)
{
    auto lambda = [=]()
    {
        ...
        DisplayThisType<decltype(intConstPointerConst)> intConstPointerConstToCheck; // ParameterType is [const int* const]
    };
}*/
...
/*TEST(AlbaTypeDisplayerInCompilationTest, DisplayThisTypeWorksUsingLambdaInitCapture)
{
            ...
            ]()
    {
        ...
        DisplayThisType<decltype(initializedWithLValueReference)> lValueReferenceToCheck; // ParameterType is [const int]
        DisplayThisType<decltype(initializedWithLValueConstReference)> lValueConstReferenceToCheck; // ParameterType is [const int]
        ...
        DisplayThisType<decltype(initializedWithIntConstPointer)> intConstPointerToCheck; // ParameterType is [const int* const]
        DisplayThisType<decltype(initializedWithIntPointerConst)> intPointerConstToCheck; // ParameterType is [int* const]
        DisplayThisType<decltype(initializedWithIntConstPointerConst)> intConstPointerConstToCheck; // ParameterType is [const int* const]
    };
}*/
