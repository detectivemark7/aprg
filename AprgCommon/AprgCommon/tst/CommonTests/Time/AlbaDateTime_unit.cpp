...
{
    AlbaDateTime dateTime(
                AlbaDateTime::createFromTotalDaysAndSecondsAndMicroSeconds(736974U, 17984U, 32487U));
...
TEST(AlbaDateTimeTest, OutputStreamOperatorWorksForPrintObjectWithDifferentTypes)
{
    ...
    EXPECT_EQ(" 1 * 2017-10-06 04:59:44.032487", convertToString(dateTime.getPrintObject<AlbaDateTime::PrintFormat::Type1>()));
