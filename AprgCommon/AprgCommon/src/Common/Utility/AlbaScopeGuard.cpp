...
AlbaScopeGuard::AlbaScopeGuard(OnExitFunction const& functionParameter)
    : m_onExitFunction(functionParameter)
{}

AlbaScopeGuard::AlbaScopeGuard(OnExitFunction && functionParameter)
    : m_onExitFunction(move(functionParameter))
{}
