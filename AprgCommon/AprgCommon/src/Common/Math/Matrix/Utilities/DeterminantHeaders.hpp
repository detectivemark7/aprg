...
unsigned int getIndexWithHighestNumberOfZeros(ListOfAlbaMatrixData<DataType> const& rowsAndColumns);

template <typename DataType>
unsigned int getIndexWithHighestNumberOfNonZeros(ListOfAlbaMatrixData<DataType> const& rowsAndColumns);
