...
string getStringAndReplaceNonAlphanumericCharactersToUnderScore(string const& path) {
    ...
    string correctPath = accumulate(
        ...
        [&isPreviousCharacterNonAlphanumeric](string const& currentString, char const currentCharacter) {
...
template void splitToStrings<SplitStringType::WithoutDelimeters>(
    strings& listOfStrings, string const& mainString, string const& delimiter);
...
string combineStrings(strings const& listOfStrings, string const& delimiters) {
    string result = accumulate(
        ...
        [&delimiters](string const& previousResult, string const& currentString) {
...
string getCorrectPathWithReplacedSlashCharacters(string const& path, string const& slashCharacterString) {
    ...
    string correctPath = accumulate(
        path.cbegin(), path.cend(), string(),
        [&wasSlashDetected, slashCharacterString](string const& currentString, char const currentCharacter) {
            string partialResult(currentString);
