...
#define ALBA_MACROS_FOR_EACH_EVAL2(...) \
    ALBA_MACROS_FOR_EACH_EVAL1(ALBA_MACROS_FOR_EACH_EVAL1(ALBA_MACROS_FOR_EACH_EVAL1(__VA_ARGS__)))
#define ALBA_MACROS_FOR_EACH_EVAL3(...) \
    ALBA_MACROS_FOR_EACH_EVAL2(ALBA_MACROS_FOR_EACH_EVAL2(ALBA_MACROS_FOR_EACH_EVAL2(__VA_ARGS__)))
#define ALBA_MACROS_FOR_EACH_EVAL4(...) \
    ALBA_MACROS_FOR_EACH_EVAL3(ALBA_MACROS_FOR_EACH_EVAL3(ALBA_MACROS_FOR_EACH_EVAL3(__VA_ARGS__)))
#define ALBA_MACROS_FOR_EACH_EVAL(...) \
    ALBA_MACROS_FOR_EACH_EVAL4(ALBA_MACROS_FOR_EACH_EVAL4(ALBA_MACROS_FOR_EACH_EVAL4(__VA_ARGS__)))
...
#define ALBA_MACROS_FOR_EACH0(f, x, peek, ...) \
    f(x) ALBA_MACROS_FOR_EACH_NEXT(peek, ALBA_MACROS_FOR_EACH1)(f, peek, __VA_ARGS__)
#define ALBA_MACROS_FOR_EACH1(f, x, peek, ...) \
    f(x) ALBA_MACROS_FOR_EACH_NEXT(peek, ALBA_MACROS_FOR_EACH0)(f, peek, __VA_ARGS__)

#define ALBA_MACROS_FOR_EACH_LIST_NEXT1(test, next) ALBA_MACROS_FOR_EACH_NEXT0(test, ALBA_MACROS_FOR_EACH_COMMA next, 0)
#define ALBA_MACROS_FOR_EACH_LIST_NEXT(test, next) \
    ALBA_MACROS_FOR_EACH_LIST_NEXT1(ALBA_MACROS_FOR_EACH_GET_END test, next)

#define ALBA_MACROS_FOR_EACH_LIST0(f, x, peek, ...) \
    f(x) ALBA_MACROS_FOR_EACH_LIST_NEXT(peek, ALBA_MACROS_FOR_EACH_LIST1)(f, peek, __VA_ARGS__)
#define ALBA_MACROS_FOR_EACH_LIST1(f, x, peek, ...) \
    f(x) ALBA_MACROS_FOR_EACH_LIST_NEXT(peek, ALBA_MACROS_FOR_EACH_LIST0)(f, peek, __VA_ARGS__)
