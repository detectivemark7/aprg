...
private:
    ...
    void updateDescriptionFromUserWithoutParameter(
        IfsDefinitionType const currentDefinitionType, std::string const& name, std::string const& description);
    void updateDescriptionFromUserWithParameter(
        IfsDefinitionType const currentDefinitionType, std::string const& name, std::string const& parameterName,
        std::string const& description);
