...
*******************************************************************************
* @file                  $HeadURL:
*https://wrscmi.inside.nsn.com/isource/svnroot/SCI_I_CCS/tags/MB_CCS_COMMON_AASYSCOMGW_4.2.0/overlay/I_Interface/Platform_Env/CCS_ENV/SHARED/MCU_RT/Definitions/IfAaSysComGw_Defs.h
*$
