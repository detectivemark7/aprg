...
TEST(DatabaseTest, DISABLED_SaveAndLoadFile) {
    ...
    databaseToBeSaved.constantNameToConstantDetailsMap["ConstantName"].descriptionFromUser =
        "ConstantDescriptionFromUser";
    ...
    databaseToBeSaved.structureNameToStructureDetailsMap["StructureName"].parameters["ParameterName"].type =
        "ParameterType";
    databaseToBeSaved.structureNameToStructureDetailsMap["StructureName"].parameters["ParameterName"].name =
        "ParameterName";
    databaseToBeSaved.structureNameToStructureDetailsMap["StructureName"].parameters["ParameterName"].description =
        "ParameterDescription";
    databaseToBeSaved.structureNameToStructureDetailsMap["StructureName"]
        .parameters["ParameterName"]
        .descriptionFromUser = "ParameterDescriptionFromUser";
    databaseToBeSaved.structureNameToStructureDetailsMap["StructureName"].parametersWithCorrectOrder.emplace_back(
        "ParameterName");
    ...
    databaseToBeSaved.enumNameToEnumDetailsMap["EnumName"].parameters["ParameterName"].description =
        "ParameterDescription";
    ...
    EXPECT_EQ(
        "ConstantDescriptionFromUser",
        loadedDatabase.constantNameToConstantDetailsMap.at("ConstantName").descriptionFromUser);
    ...
    EXPECT_EQ(
        "ParameterType",
        loadedDatabase.structureNameToStructureDetailsMap.at("StructureName").parameters.at("ParameterName").type);
    EXPECT_EQ(
        "ParameterName",
        loadedDatabase.structureNameToStructureDetailsMap.at("StructureName").parameters.at("ParameterName").name);
    EXPECT_EQ(
        "ParameterDescription", loadedDatabase.structureNameToStructureDetailsMap.at("StructureName")
                                    .parameters.at("ParameterName")
                                    .description);
    EXPECT_EQ(
        "ParameterDescriptionFromUser", loadedDatabase.structureNameToStructureDetailsMap.at("StructureName")
                                            .parameters.at("ParameterName")
                                            .descriptionFromUser);
    EXPECT_EQ(
        "ParameterName",
        loadedDatabase.structureNameToStructureDetailsMap.at("StructureName").parametersWithCorrectOrder.front());
    ...
    EXPECT_EQ(
        "ParameterName", loadedDatabase.enumNameToEnumDetailsMap.at("EnumName").parameters.at("ParameterName").name);
    EXPECT_EQ(
        "ParameterValue", loadedDatabase.enumNameToEnumDetailsMap.at("EnumName").parameters.at("ParameterName").value);
    EXPECT_EQ(
        "ParameterDescription",
        loadedDatabase.enumNameToEnumDetailsMap.at("EnumName").parameters.at("ParameterName").description);
    EXPECT_EQ(
        "ParameterDescriptionFromUser",
        loadedDatabase.enumNameToEnumDetailsMap.at("EnumName").parameters.at("ParameterName").descriptionFromUser);
