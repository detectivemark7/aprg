...
TEST(UciUtilitiesTest, UpdateCalculationDetailsWorksWithMultiPvWithScore) {
    ...
    Variation expectedVariation{-69, 0, {"e8f7", "e5e6", "f7e6"}};
...
TEST(UciUtilitiesTest, UpdateCalculationDetailsWorksWithMultiPvWithMate) {
    CalculationDetails actualDetails{};
    UciInterpreter interpreter(actualDetails);
    ...
    Variation expectedVariation{0, -3, {"b2d2"}};
    Variations expectedVariations{expectedVariation};
...
TEST(UciUtilitiesTest, UpdateCalculationDetailsWorksWithOverwritingVariationIfSameMultiPv) {
    CalculationDetails actualDetails{};
    UciInterpreter interpreter(actualDetails);
    ...
    Variation expectedVariation{98, 0, {"g1e2", "c7c5", "d2e4"}};
    Variations expectedVariations{expectedVariation};
...
TEST(UciUtilitiesTest, UpdateCalculationDetailsWorksWithExpandingVariationsByOne) {
    CalculationDetails actualDetails{};
    UciInterpreter interpreter(actualDetails);
    ...
    Variation expectedVariation1{14, 0, {"f6e4", "b1d2", "d8f6"}};
    Variation expectedVariation2{98, 0, {"g1e2", "c7c5", "d2e4"}};
...
TEST(UciUtilitiesTest, UpdateCalculationDetailsWorksWithExpandingVariationsMoreThanOne) {
    CalculationDetails actualDetails{};
    UciInterpreter interpreter(actualDetails);
...
TEST(UciUtilitiesTest, UpdateCalculationDetailsWorksOnInfoExample4) {
    CalculationDetails actualDetails{};
    UciInterpreter interpreter(actualDetails);
...
TEST(UciUtilitiesTest, UpdateCalculationDetailsWorksOnBestMoveExample1) {
    CalculationDetails actualDetails{};
    UciInterpreter interpreter(actualDetails);
...
TEST(UciUtilitiesTest, UpdateCalculationDetailsWorksWithIgnoringStringsWithInvalidStart) {
    CalculationDetails actualDetails{};
    UciInterpreter interpreter(actualDetails);
