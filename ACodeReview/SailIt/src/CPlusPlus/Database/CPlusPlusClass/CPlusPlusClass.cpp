...
string CPlusPlusClassTemplateParameter::getString() const { return m_type.getString() + " " + m_name; }

string CPlusPlusClassTemplateParameter::getName() const { return m_name; }

CPlusPlusType CPlusPlusClassTemplateParameter::getType() const { return m_type; }

bool CPlusPlusClassTemplateParameter::operator==(
    CPlusPlusClassTemplateParameter const& cPlusPlusClassTemplateParameter) const {
...
bool CPlusPlusClassTemplateSignature::operator==(
    CPlusPlusClassTemplateSignature const& cPlusPlusClassTemplateSignature) const {
    ...
    auto mismatchPair =
        std::mismatch(m_templateParameters.cbegin(), m_templateParameters.cend(), templateParameters.cbegin());
...
CPlusPlusType& CPlusPlusClass::getTypeReference() { return m_type; }

VectorOfStrings& CPlusPlusClass::getClassNamesReference() { return m_classes; }

VectorOfStrings& CPlusPlusClass::getFunctionNamesReference() { return m_functions; }

VectorOfStrings& CPlusPlusClass::getNamespaceNamesReference() { return m_namespaces; }

VectorOfStrings& CPlusPlusClass::getVariableNamesReference() { return m_variables; }

void CPlusPlusClass::addClass(string const& className) { m_classes.push_back(className); }

void CPlusPlusClass::addFunction(string const& functionName) { m_functions.push_back(functionName); }

void CPlusPlusClass::addNamespace(string const& namespaceName) { m_namespaces.push_back(namespaceName); }
...
void CPlusPlusTemplateClass::addTemplateInstantiation(
    ...
    if (cPlusPlusClassTemplateSignature.getNumberOfParameters() == m_templateSignature.getNumberOfParameters()) {
        auto iterator =
            find(m_templateInstantiations.begin(), m_templateInstantiations.end(), cPlusPlusClassTemplateSignature);
...
CPlusPlusType CPlusPlusTemplateClass::getTemplateClassInstantiationType(
    CPlusPlusClassTemplateSignature const& cPlusPlusClassTemplateSignature) {
...
CPlusPlusType& CPlusPlusTemplateClass::getTypeReference() { return m_type; }

CPlusPlusClassTemplateSignature& CPlusPlusTemplateClass::getTemplateSignatureReference() { return m_templateSignature; }

CPlusPlusClassTemplateSignature& CPlusPlusTemplateClass::getTemplateSignatureInstantiationReference(
