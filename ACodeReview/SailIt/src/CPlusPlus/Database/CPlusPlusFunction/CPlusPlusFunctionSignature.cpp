...
CPlusPlusType& CPlusPlusFunctionSignature::getReturnTypeReference() { return m_returnType; }

CPlusPlusType CPlusPlusFunctionSignature::getReturnType() const { return m_returnType; }

void CPlusPlusFunctionSignature::setReturnType(CPlusPlusType const& type) { m_returnType = type; }

void CPlusPlusFunctionSignature::addParameter(CPlusPlusType const& type) { m_parameters.emplace_back(type, ""); }
...
bool CPlusPlusFunctionSignature::isEqualBasedFromFunctionCall(
...
CPlusPlusFunctionParameters& CPlusPlusFunctionSignature::getFunctionParametersReference() { return m_parameters; }
