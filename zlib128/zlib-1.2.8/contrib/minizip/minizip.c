...
char* argv[];
{
        ...
        for (i = 1; i < argc; i++) {
            if ((*argv[i]) == '-') {
                ...
                while ((*p) != '\0') {
                    ...
                    if ((c == 'a') || (c == 'A')) opt_overwrite = 2;
                    if ((c >= '0') && (c <= '9')) opt_compress_level = c - '0';
                    if ((c == 'j') || (c == 'J')) opt_exclude_path = 1;
    ...
    if (zipfilenamearg == 0) {
        ...
        if (opt_overwrite == 2) {
            ...
            if (check_exist_file(filename_try) == 0) opt_overwrite = 1;
            ...
            if (!((((*(argv[i])) == '-') || ((*(argv[i])) == '/')) &&
                ...
                /*
                                err = zipOpenNewFileInZip(zf,filenameinzip,&zi,
                                                 ...
                                                 opt_compress_level);
                */
                if ((password != NULL) && (err == ZIP_OK)) err = getFileCrc(filenameinzip, buf, size_buf, &crcFile);
                ...
                if (err < 0)
                    ...
                    if (err != ZIP_OK) printf("error in closing %s in the zipfile\n", filenameinzip);
                }
            }
        }
