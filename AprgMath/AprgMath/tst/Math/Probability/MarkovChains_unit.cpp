...
TEST(MarkovChainsTest, GetNextProbabilityDistributionWorksWithNoSteps)
{
    ...
    EXPECT_EQ((DistributionForTest{0, 0.75, 0, 0.25, 0}), markovChain.getNextProbabilityDistribution({0.5, 0, 0.5, 0, 0}));
    EXPECT_EQ((DistributionForTest{0.375, 0, 0.5, 0, 0.125}), markovChain.getNextProbabilityDistribution({0, 0.75, 0, 0.25, 0}));
    EXPECT_EQ((DistributionForTest{0, 0.625, 0, 0.375, 0}), markovChain.getNextProbabilityDistribution({0.375, 0, 0.5, 0, 0.125}));
    EXPECT_EQ((DistributionForTest{0.3125, 0, 0.5, 0, 0.1875}), markovChain.getNextProbabilityDistribution({0, 0.625, 0, 0.375, 0}));
}
...
TEST(MarkovChainsTest, GetNextProbabilityDistributionWorksWithSteps)
{
    ...
    EXPECT_EQ((DistributionForTest{0, 0.75, 0, 0.25, 0}), markovChain.getNextProbabilityDistribution({1, 0, 0, 0, 0}, 3));
    EXPECT_EQ((DistributionForTest{0.375, 0, 0.5, 0, 0.125}), markovChain.getNextProbabilityDistribution({1, 0, 0, 0, 0}, 4));
    EXPECT_EQ((DistributionForTest{0, 0.625, 0, 0.375, 0}), markovChain.getNextProbabilityDistribution({1, 0, 0, 0, 0}, 5));
    EXPECT_EQ((DistributionForTest{0.3125, 0, 0.5, 0, 0.1875}), markovChain.getNextProbabilityDistribution({1, 0, 0, 0, 0}, 6));
}
