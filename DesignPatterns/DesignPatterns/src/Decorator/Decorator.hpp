...
// ---> Its easy to defined new kinds of decorators independently from classes of objects they extend, even for
// unforeseen extensions.
// -> A decorator and its component aren't identical
// ---> A decorator is a transparent enclosure.
// ---> But from an object identity point of view, a decorated component is not identical to the component itself (dont
...
// ---> Component classes should only define interface and dont store data because decorators might become heavyweight
// to use in quantity.
