...
// -----> This is applicable when commands are independent, when no suitable receiver exists or when command knows its
// receiver implicitly.
...
// ---> It may be necessary therefore to store more information in the command to ensure that objects are restored to
// their original state.
// -----> The [Memento] pattern can be applied to give the command access to this information without exposing the
