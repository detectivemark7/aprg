...
// ---> When prdocut objects familty are designed to work together, its important to stick with one family
// (AbstractFactory makes it easy to enforce).
...
// -----> This might require a new concrete facoty subclass for each product family, even if the product families differ
// only slightly.
// ---> Prototype is another way to do the creation of each product.
// -----> A ConcreteFactory is initialized with prototypes of each product, and its creates a new product by cloning its
// prototype.
