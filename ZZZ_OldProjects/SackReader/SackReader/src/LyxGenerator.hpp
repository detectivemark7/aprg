...
private:
    ...
    void saveTypedefDefinitionSubsubsectionForPrimitiveType(
        std::string const& primitiveTypeName, std::ofstream& typedefDefinitionsStream);
    void saveTypedefDefinitionSubsubsectionWithTypedefDetails(
        TypedefDetails const& typedefDetails, std::ofstream& typedefDefinitionsStream);
    ...
    void generateUnionForDisplayTablesIfNeeded(
        std::string const& unionName, DisplayTable& displayTable, std::string const& indentionInType,
        bool const areInnerStructuresGenerated);
    ...
    std::string getDescriptionString(
        std::string const& printIdentifier, std::string const& description, std::string const& descriptionFromUser);
