...
bool CommentStateMachine::isInSingleLineComment() const { return m_state == State::DoubleSlash; }
...
bool CommentStateMachine::isInComment() const { return isInSingleLineComment() || isInMultilineComment(); }
