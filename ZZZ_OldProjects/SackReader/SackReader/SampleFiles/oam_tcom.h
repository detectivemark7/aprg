...
*******************************************************************************
* @file                  $HeadURL:
*https://wrscmi.inside.nsn.com/isource/svnroot/BTS_I_COMMON_APPL/tags/COMMON_APPL_ENV_1803_001_00/I_Interface/Application_Env/Messages/oam_tcom.h
*$
 ...
 *
 *  btsSwVersion                 start of dynamic data for ASCII encoded BTS SW Version (without null terminator), the
 *size is indicated by btsSwVersionLength
 *
 ***********************************************************************/
