...
*******************************************************************************
* @file                  $HeadURL:
*https://wrscmi.inside.nsn.com/isource/svnroot/BTS_I_COMMON_APPL/tags/COMMON_APPL_ENV_1803_001_00/I_Interface/Application_Env/Definitions/DOpenIUBCommonDefs.h
*$
...
/* OWN DEFINITIONS */
#define IB_SG_DATA_BYTE_LEN                                          \
    29                        /* 3GPP TS 25.331 v4.2.0:              \
...
* @def MAX_CTFC :                         Nokia supported value 65535, Calculated CTFC -1 according to TS 25.331, 3GPP
*16777215.
...
* @def MAX_NR_OF_POSS_SEC_SERV_HSDSCH :      Maximum number of Possible Secondary Serving HS-DSCH cells of a Primary
*Serving HS-DSCH cell. Note: This constant is used only in NBAP Audit Response and RSI message. Nokia-supported value
*(from RAN3067 onwards) = 23, 3GPP TS 25.433 = 33.
* @def MAX_NUM_OF_WPAS_ASSOCIATED_TO_TRX :   Max number of associated WPAs to TRX and associated TRXes to WPAs
*(57833ESPE04).
* @def MAX_NUM_OF_TRXES_ASSOCIATED_TO_WPA :
* @def MAX_NUM_OF_PIC_POOLS :                PIC Pool information RAN1308 HSUPA Parallel Interference Cancellation and
*CN4155 CR1713 PIC configuration changes.
* @def MAX_NUM_OF_PIC_POOL_LCR_INFO :        PIC Pool information RAN1308 HSUPA Parallel Interference Cancellation and
*CN4155 CR1713 PIC configuration changes.
* @def LN_MAX_NUM_OF_TX_ANTENNAS_PER_LOCAL_CELL : Max number of RX and TX antennas per local cell, Only used by uRec and
*LTE.
* @def LN_MAX_NUM_OF_RX_ANTENNAS_PER_LOCAL_CELL : Max number of RX and TX antennas per local cell, Only used by uRec and
*LTE.
