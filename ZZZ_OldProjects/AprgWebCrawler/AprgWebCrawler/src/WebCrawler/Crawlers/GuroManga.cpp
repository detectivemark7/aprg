    ...
    if (!htmlFileStream.is_open()) {
        ...
        while (htmlFileReader.isNotFinished()) {
            ...
            if (isStringFoundInsideTheOtherStringCaseSensitive(lineInHtmlFile, R"(<div class="page-image">)")) {
                ...
                isDivClassImage && isStringFoundInsideTheOtherStringCaseSensitive(lineInHtmlFile, R"(<a href=")")) {
                ...
                isDivClassImage && isStringFoundInsideTheOtherStringCaseSensitive(lineInHtmlFile, R"(<title>)")) {
        ...
        m_localPathForCurrentFileToDownload =
            m_webCrawler.getDownloadDirectory() + title + R"(\)" + imageWebPathHandler.getFile();
    }
}
