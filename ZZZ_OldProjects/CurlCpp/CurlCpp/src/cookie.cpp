...
curl::cookie::cookie(
    const string &name, const string &value, const cookie_datetime &datetime, const string &path, const string &domain,
    const bool secure) {
...
curl::cookie::cookie(
    const char *name, const char *value, const cookie_datetime &datetime, const char *path, const char *domain,
    const bool secure) {
    set_name(name)->set_value(value)->set_path(path)->set_domain(domain)->set_secure(secure)->set_datetime(datetime);
}
...
curl::cookie_datetime curl::cookie::get_datetime() const NOEXCEPT { return this->datetime; }
