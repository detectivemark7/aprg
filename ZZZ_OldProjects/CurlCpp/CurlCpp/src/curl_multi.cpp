...
void curl_multi::multi_deleter::operator()(CURLM *ptr) const { curl_multi_cleanup(ptr); }
...
void curl_multi::wait(
    struct curl_waitfd extra_fds[], const unsigned int extra_nfds, const int timeout_ms, int *numfds) {
