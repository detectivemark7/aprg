...
template bool download<DownloadType::LowSpeedLimit, DownloadType::MozillaFireFox>(
    AlbaWebPathHandler const& webPath, AlbaLocalPathHandler const& windowsPath);
template bool download<DownloadType::MozillaFireFox, DownloadType::PrintDownloadProgress>(
    AlbaWebPathHandler const& webPath, AlbaLocalPathHandler const& windowsPath);
template bool downloadUntilSuccessful<DownloadType::LowSpeedLimit, DownloadType::MozillaFireFox>(
    AlbaWebPathHandler const& webPath, AlbaLocalPathHandler const& windowsPath);
template bool
downloadBinaryFile<DownloadType::LowSpeedLimit, DownloadType::MozillaFireFox, DownloadType::PrintDownloadProgress>(
    AlbaWebPathHandler const& webPath, AlbaLocalPathHandler const& windowsPath);
template bool downloadBinaryFileUntilSuccessful<
    DownloadType::LowSpeedLimit, DownloadType::MozillaFireFox, DownloadType::PrintDownloadProgress>(
    AlbaWebPathHandler const& webPath, AlbaLocalPathHandler const& windowsPath);
template bool downloadBinaryFileWithFiniteNumberOfTries<
    DownloadType::LowSpeedLimit, DownloadType::MozillaFireFox, DownloadType::PrintDownloadProgress>(
    AlbaWebPathHandler const& webPath, AlbaLocalPathHandler const& windowsPath, int const totalNumberOfTries);
template bool downloadBinaryFile<DownloadType::LowSpeedLimit>(
    AlbaWebPathHandler const& webPath, AlbaLocalPathHandler const& windowsPath);
template bool downloadBinaryFileUntilSuccessful<
    DownloadType::LowSpeedLimit, DownloadType::MozillaFireFox, DownloadType::PrintDownloadProgress, DownloadType::Ssl>(
    AlbaWebPathHandler const& webPath, AlbaLocalPathHandler const& windowsPath);
template bool downloadBinaryFileWithFiniteNumberOfTries<
    DownloadType::LowSpeedLimit, DownloadType::MozillaFireFox, DownloadType::PrintDownloadProgress, DownloadType::Ssl>(
    AlbaWebPathHandler const& webPath, AlbaLocalPathHandler const& windowsPath, int const totalNumberOfTries);
