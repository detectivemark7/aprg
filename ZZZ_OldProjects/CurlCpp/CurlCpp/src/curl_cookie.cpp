...
void curl_cookie::set_file(const string &file = "") { this->easy.add<CURLOPT_COOKIEFILE>(file.c_str()); }

// Implementation of set_cookie_list method.
void curl_cookie::set(curl::cookie &cookie) { this->easy.add<CURLOPT_COOKIELIST>(cookie.get_formatted().c_str()); }
...
void curl_cookie::erase_session() { this->easy.add<CURLOPT_COOKIELIST>("SESS"); }
