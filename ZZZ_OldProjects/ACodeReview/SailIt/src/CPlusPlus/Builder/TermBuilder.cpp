...
void TermBuilder::setLineNumber(unsigned int const lineNumber) { m_lineNumber = lineNumber; }

void TermBuilder::addNewLine() { m_terms.emplace_back(TermType::NewLine, "\n", m_lineNumber); }

void TermBuilder::addWhiteSpace() { m_terms.emplace_back(TermType::WhiteSpace, " ", m_lineNumber); }

void TermBuilder::addSemiColon() { m_terms.emplace_back(TermType::Operator, ";", m_lineNumber); }
...
void TermBuilder::addKeyword(string const& content) { m_terms.emplace_back(TermType::Keyword, content, m_lineNumber); }
...
void TermBuilder::addMacro(string const& content) { m_terms.emplace_back(TermType::Macro, content, m_lineNumber); }

void TermBuilder::addOperator(string const& content) {
    m_terms.emplace_back(TermType::Operator, content, m_lineNumber);
}

void TermBuilder::addUnknown(string const& content) { m_terms.emplace_back(TermType::Unknown, content, m_lineNumber); }

void TermBuilder::addIgnorable(string const& content) {
    m_terms.emplace_back(TermType::ProcessedTerm, content, m_lineNumber);
}

void TermBuilder::addTerm(Term const& term) { m_terms.emplace_back(term); }

Term& TermBuilder::getLastTermReference() { return m_terms.back(); }
