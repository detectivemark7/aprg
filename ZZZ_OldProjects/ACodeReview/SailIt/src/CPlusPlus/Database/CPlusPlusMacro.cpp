...
VectorOfTerms& CPlusPlusMacro::getMacroEquivalent() { return m_macroEquivalent; }

VectorOfStrings& CPlusPlusMacro::getMacroParameters() { return m_macroParameters; }

MapOfPositionToParameter& CPlusPlusMacro::getPositionToParameter() { return m_positionToParameter; }
...
void CPlusPlusMacro::addMacroEquivalent(Term const& term) { m_macroEquivalent.push_back(term); }
