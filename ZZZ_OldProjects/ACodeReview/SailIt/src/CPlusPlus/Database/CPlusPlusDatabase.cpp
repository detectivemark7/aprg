...
CPlusPlusDatabase::CPlusPlusDatabase() : m_isModified(true) {
...
void CPlusPlusDatabase::initializeCStyleArray() {
    ...
    templateSignature.addParameter(
        CPlusPlusType("__CStyleArray_ElementType", CPlusPlusTypeType::TemplateType), "__CStyleArray_ElementType");
    ...
    performInTemplateClass("__CStyleArray", [&]() {
        ...
        cPlusPlusFunctionSignature.setReturnType(
            CPlusPlusType("__CStyleArray_ElementType", CPlusPlusTypeType::TemplateType));
        cPlusPlusFunctionSignature.addParameter(
            CPlusPlusType("int", CPlusPlusTypeType::Primitive), "__CStyleArray_Index");
...
bool CPlusPlusDatabase::isDatabaseModified() const { return m_isModified; }

bool CPlusPlusDatabase::isClass(string const& className) const { return m_classes.find(className) != m_classes.end(); }
...
bool CPlusPlusDatabase::isMacro(string const& macroName) const { return m_macros.find(macroName) != m_macros.end(); }
...
bool CPlusPlusDatabase::isType(string const& typeName) const { return m_types.find(typeName) != m_types.end(); }
...
CPlusPlusClass& CPlusPlusDatabase::getClassReference(string const& className) { return m_classes[className]; }
...
CPlusPlusScope& CPlusPlusDatabase::getCurrentScope() { return m_scopes.back(); }

CPlusPlusFunction& CPlusPlusDatabase::getFunctionReference(string const& functionName) {
    return m_functions[functionName];
}

CPlusPlusFunctionOptional CPlusPlusDatabase::getFunctionOptionalInClass(
    string const& className, string const& functionName) {
...
CPlusPlusFunctionOptional CPlusPlusDatabase::getFunctionOptionalInTemplateClass(
...
CPlusPlusMacro& CPlusPlusDatabase::getMacroReference(string const& macroName) { return m_macros[macroName]; }
...
Classes& CPlusPlusDatabase::getClassesReference() { return m_classes; }

Functions& CPlusPlusDatabase::getFunctionsReference() { return m_functions; }

IncludeFiles& CPlusPlusDatabase::getIncludeFilesReference() { return m_includedFiles; }

Macros& CPlusPlusDatabase::getMacrosReference() { return m_macros; }

Namespaces& CPlusPlusDatabase::getNamespacesReference() { return m_namespaces; }

TemplateClasses& CPlusPlusDatabase::getTemplateClassesReference() { return m_templateClasses; }

Types& CPlusPlusDatabase::getTypesReference() { return m_types; }

VectorOfStrings& CPlusPlusDatabase::getUsingNamespacesReference() { return m_usingNamespaces; }

Variables& CPlusPlusDatabase::getVariablesReference() { return m_variables; }

void CPlusPlusDatabase::clearIsDatabaseModified() { m_isModified = false; }
...
void CPlusPlusDatabase::addTemplateClass(
    string const& templateClassName, CPlusPlusClassTemplateSignature const& cPlusPlusClassTemplateSignature) {
    m_isModified = true;
    m_templateClasses.emplace(
        getAliasWithCurrentScope(templateClassName),
        CPlusPlusTemplateClass(templateClassName, cPlusPlusClassTemplateSignature));
}
...
void CPlusPlusDatabase::removeMacro(string const& macroName) { m_macros.erase(macroName); }

void CPlusPlusDatabase::copyContentsOf(CPlusPlusDatabase const& cPlusPlusDatabase) {
    m_isModified = true;
    copy(
        cPlusPlusDatabase.m_classes.begin(), cPlusPlusDatabase.m_classes.end(), inserter(m_classes, m_classes.begin()));
    copy(
        cPlusPlusDatabase.m_functions.begin(), cPlusPlusDatabase.m_functions.end(),
        inserter(m_functions, m_functions.begin()));
    // copy(cPlusPlusDatabase.m_includedFiles.begin(), cPlusPlusDatabase.m_includedFiles.end(),
    // inserter(m_includedFiles, m_includedFiles.begin()));
    copy(cPlusPlusDatabase.m_macros.begin(), cPlusPlusDatabase.m_macros.end(), inserter(m_macros, m_macros.begin()));
    copy(
        cPlusPlusDatabase.m_namespaces.begin(), cPlusPlusDatabase.m_namespaces.end(),
        inserter(m_namespaces, m_namespaces.begin()));
    copy(
        cPlusPlusDatabase.m_templateClasses.begin(), cPlusPlusDatabase.m_templateClasses.end(),
        inserter(m_templateClasses, m_templateClasses.begin()));
    copy(cPlusPlusDatabase.m_types.begin(), cPlusPlusDatabase.m_types.end(), inserter(m_types, m_types.begin()));
    copy(
        cPlusPlusDatabase.m_variables.begin(), cPlusPlusDatabase.m_variables.end(),
        inserter(m_variables, m_variables.begin()));
}
