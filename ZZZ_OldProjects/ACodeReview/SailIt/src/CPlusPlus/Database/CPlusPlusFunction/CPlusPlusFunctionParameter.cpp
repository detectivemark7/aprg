...
bool CPlusPlusFunctionParameter::isEqualBasedFromFunctionCall(
    CPlusPlusFunctionParameter const& cPlusPlusFunctionParameter) const {
...
string CPlusPlusFunctionParameter::getName() const { return m_name; }

CPlusPlusType CPlusPlusFunctionParameter::getType() const { return m_type; }
