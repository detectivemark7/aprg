...
bool TermAnalyzer::isClosingPartnerFoundAndMoveLooper(
...
void TermAnalyzer::connectLooper(Looper&) {}
template void TermAnalyzer::connectLooper<LooperConnector::None>(Looper&);
template <>
void TermAnalyzer::connectLooper<LooperConnector::WhiteSpaceAndNewLine>(Looper& movableLooper) {
