...
GenericMessage MessageFactory::createHwConfigurationMessageForRel3BasedFromLogs() {
    ...
    // payload.tupConfigurationInfo.tupAddress = {0x35, 0x00, 0x01, 0x0a, 0x45, 0x5d, 0x45, 0x00, 0x00, 0x00, 0x00,
...
GenericMessage MessageFactory::createOneTransportBearerModificationPrepareForUser() {
    ...
    STransportBearerModificationPrepareReq& tbModificationPreparePayload(
    ...
    STransportBearerModificationData& dynamicPayload1(
        tbModificationPrepareMessage.getDynamicPayloadReferenceAtAndCreateIfNeeded(0));
...
GenericMessage MessageFactory::createOneTransportBearerModificationCommitForUser() {
    ...
    STransportBearerModificationCommitReq& tbModificationCommitPayload(
...
GenericMessage MessageFactory::createOneTransportBearerModificationCancelForUser() {
    ...
    STransportBearerModificationCancelReq& tbModificationCancelPayload(
...
GenericMessage MessageFactory::createOneTransportBearerReallocationPrepareForUser() {
    ...
    STransportBearerReallocationPrepareReq& tbReallocationPreparePayload(
    ...
    STransportBearerReallocationData& dynamicPayload1(
        tbReallocationPrepareMessage.getDynamicPayloadReferenceAtAndCreateIfNeeded(0));
    dynamicPayload1.transportBearerId = 100004;
...
GenericMessage MessageFactory::createOneTransportBearerReallocationCommitForUser() {
    ...
    STransportBearerReallocationCommitReq& tbReallocationCommitPayload(
...
GenericMessage MessageFactory::createOneTransportBearerReallocationCleanupForUser() {
    ...
    STransportBearerReallocationCleanupReq& tbReallocationCleanupPayload(
        tbReallocationCleanupMessage.getStaticPayloadReference());
...
GenericMessage MessageFactory::createOneTransportBearerReallocationCancelForUser() {
    ...
    STransportBearerReallocationCancelReq& tbReallocationCancelPayload(
        tbReallocationCancelMessage.getStaticPayloadReference());
