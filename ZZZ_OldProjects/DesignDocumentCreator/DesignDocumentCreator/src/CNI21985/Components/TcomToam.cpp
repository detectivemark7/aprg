...
void TcomToam::handleHwConfigurationMessage(GenericMessage const& genericMessage) {
    ...
    SpecificStaticMessage<MessageName::TC_HW_CONFIGURATION_MSG> message(
        convertGenericToSpecificStatic<MessageName::TC_HW_CONFIGURATION_MSG>(genericMessage));
...
void TcomToam::handleHwConfigurationChangeMessage(GenericMessage const& genericMessage) const {
    ...
    SpecificStaticMessage<MessageName::TC_HW_CONFIGURATION_CHANGE_MSG> message(
        convertGenericToSpecificStatic<MessageName::TC_HW_CONFIGURATION_CHANGE_MSG>(genericMessage));
...
void TcomToam::handleLinkStatesMessage(GenericMessage const& genericMessage) const {
    ...
    SpecificStaticMessage<MessageName::TC_LINK_STATES_MSG> message(
        convertGenericToSpecificStatic<MessageName::TC_LINK_STATES_MSG>(genericMessage));
