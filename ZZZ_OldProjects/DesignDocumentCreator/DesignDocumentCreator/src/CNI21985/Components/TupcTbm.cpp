...
TupcTbm::TupcTbm(ComponentName const componentName) : Component(componentName) {}

void TupcTbm::handleStartup() { logNoteOnComponent("TUPC/TBM **automatically** starts when TUPCexe starts."); }
...
void TupcTbm::handleTupcTbmConfigurationMsg(GenericMessage const& genericMessage) {
    ...
    SpecificStaticMessage<MessageName::TUPC_TBM_CONFIGURATION_MSG> message(
        convertGenericToSpecificStatic<MessageName::TUPC_TBM_CONFIGURATION_MSG>(genericMessage));
...
void TupcTbm::handleTransportConnectionReleaseResp(GenericMessage const&) {
    if (m_modifyTransactionType == 6) {
        ...
        logNoteOnComponent(
            "TUPC/TBM sends TC_TRANSPORT_BEARER_RELEASE_MSG for every TUP_TRANSPORT_CONNECTION_RELEASE_RESP_MSG.");
...
void TupcTbm::sendCmBearersSetupReqBasedOnTbRegisterMsg(GenericMessage const& tbRegisterGenericMessage) const {
    ...
    SpecificDynamicArrayMessage<MessageName::TC_TRANSPORT_BEARER_REGISTER_MSG> tbRegisterMessage(
        convertGenericToSpecificDynamicArray<MessageName::TC_TRANSPORT_BEARER_REGISTER_MSG>(tbRegisterGenericMessage));
...
void TupcTbm::sendCmBearersReleaseReqBasedOnTbUnregisterMsg(GenericMessage const& tbUnregisterGenericMessage) const {
    ...
    SpecificDynamicArrayMessage<MessageName::TC_TRANSPORT_BEARER_UNREGISTER_MSG> tbUnregisterMessage(
        convertGenericToSpecificDynamicArray<MessageName::TC_TRANSPORT_BEARER_UNREGISTER_MSG>(
            tbUnregisterGenericMessage));
...
void TupcTbm::sendCmBearersModifyReqBasedOnTbModificationPrepareReqMsg(
    ...
    SpecificDynamicArrayMessage<MessageName::TC_TRANSPORT_BEARER_MODIFICATION_PREPARE_REQ_MSG>
        tbModificationPrepareMessage(
            convertGenericToSpecificDynamicArray<MessageName::TC_TRANSPORT_BEARER_MODIFICATION_PREPARE_REQ_MSG>(
                tbModificationPrepareGenericMessage));
    STransportBearerModificationPrepareReq const& tbModificationPreparePayloadMsg(
        tbModificationPrepareMessage.getStaticPayloadReference());
...
void TupcTbm::sendCmBearersModifyReqBasedOnTbModificationCommitReqMsg(
    ...
    SpecificStaticMessage<MessageName::TC_TRANSPORT_BEARER_MODIFICATION_COMMIT_REQ_MSG> tbModificationCommitMessage(
        convertGenericToSpecificStatic<MessageName::TC_TRANSPORT_BEARER_MODIFICATION_COMMIT_REQ_MSG>(
            tbModificationCommitGenericMessage));
    STransportBearerModificationCommitReq const& tbModificationCommitPayloadMsg(
        tbModificationCommitMessage.getStaticPayloadReference());
    ...
    logNoteOnComponent(
        "TUPC/TBM uses transport bearer modification type as **ECmBearersModifyTransactionType_ModificationCommit**");
    payload.transactionType = ECmBearersModifyTransactionType_ModificationCommit;
    send(ComponentName::TupcCm, convertSpecificDynamicArrayToGeneric(specificMessage));
    logNoteOnPreviousMessage("TUPC/TBM sends TUPC_CM_BEARERS_MODIFY_REQ_MSG to TUPC/CM.");
}

void TupcTbm::sendCmBearersModifyReqBasedOnTbModificationCancelReqMsg(
    ...
    SpecificStaticMessage<MessageName::TC_TRANSPORT_BEARER_MODIFICATION_CANCEL_REQ_MSG> tbModificationCancelMessage(
        convertGenericToSpecificStatic<MessageName::TC_TRANSPORT_BEARER_MODIFICATION_CANCEL_REQ_MSG>(
            tbModificationCancelGenericMessage));
    STransportBearerModificationCancelReq const& tbModificationCancelPayloadMsg(
        tbModificationCancelMessage.getStaticPayloadReference());
    ...
    payload.numConnections = 0;
    logNoteOnComponent(
        "TUPC/TBM uses transport bearer modification type as **ECmBearersModifyTransactionType_ModificationCancel**");
    payload.transactionType = ECmBearersModifyTransactionType_ModificationCancel;
    send(ComponentName::TupcCm, convertSpecificDynamicArrayToGeneric(specificMessage));
    logNoteOnPreviousMessage("TUPC/TBM sends TUPC_CM_BEARERS_MODIFY_REQ_MSG to TUPC/CM.");
}

void TupcTbm::sendCmBearersModifyReqBasedOnReallocationCommitReqMsg(
    ...
    SpecificStaticMessage<MessageName::TC_TRANSPORT_BEARER_REALLOCATION_COMMIT_REQ_MSG> tbReallocationCommitMessage(
        convertGenericToSpecificStatic<MessageName::TC_TRANSPORT_BEARER_REALLOCATION_COMMIT_REQ_MSG>(
            tbReallocationCommitGenericMessage));
    STransportBearerReallocationCommitReq const& tbReallocationCommitPayloadMsg(
        tbReallocationCommitMessage.getStaticPayloadReference());
    ...
    payload.numConnections = 0;
    logNoteOnComponent(
        "TUPC/TBM uses transport bearer modification type as **ECmBearersModifyTransactionType_ReallocationCommit**");
    payload.transactionType = ECmBearersModifyTransactionType_ReallocationCommit;
    send(ComponentName::TupcCm, convertSpecificDynamicArrayToGeneric(specificMessage));
    logNoteOnPreviousMessage("TUPC/TBM sends TUPC_CM_BEARERS_MODIFY_REQ_MSG to TUPC/CM.");
}

void TupcTbm::sendTransportConnectionSetupReqsBasedOnCmBearersSetupResp(
    GenericMessage const& cmBearerGenericMessage) const {
    SpecificDynamicArrayMessage<MessageName::TUPC_CM_BEARERS_SETUP_RESP_MSG> cmBearerMessage(
        convertGenericToSpecificDynamicArray<MessageName::TUPC_CM_BEARERS_SETUP_RESP_MSG>(cmBearerGenericMessage));
    ...
    for (unsigned int connection = 0; connection < cmBearerMsg.numConnections; connection++) {
        ...
        SCmBearersSetupRespDynamicPart const& dynamicPart(
            cmBearerMessage.getDynamicPayloadReferenceAtAndCreateIfNeeded(connection));
...
void TupcTbm::sendTransportConnectionReleaseReqsBasedOnCmBearersReleaseResp(
    GenericMessage const& cmBearerGenericMessage) const {
    SpecificDynamicArrayMessage<MessageName::TUPC_CM_BEARERS_RELEASE_RESP_MSG> cmBearerMessage(
        convertGenericToSpecificDynamicArray<MessageName::TUPC_CM_BEARERS_RELEASE_RESP_MSG>(cmBearerGenericMessage));
    ...
    for (unsigned int connection = 0; connection < cmBearerMsg.numConnections; connection++) {
        ...
        SCmBearersReleaseRespDynamicPart const& dynamicPart(
            cmBearerMessage.getDynamicPayloadReferenceAtAndCreateIfNeeded(connection));
        payload.fpSicAddress = dynamicPart.fpSicAddress;
        payload.localPort = dynamicPart.localPort;
        send(ComponentName::Dsp, convertSpecificStaticToGeneric(specificMessage));
...
void TupcTbm::sendTransportConnectionReleaseReqsBasedOnCmBearersUpdateInd(
    GenericMessage const& cmBearerGenericMessage) const {
    SpecificDynamicArrayMessage<MessageName::TUPC_CM_BEARERS_UPDATE_IND_MSG> cmBearerMessage(
        convertGenericToSpecificDynamicArray<MessageName::TUPC_CM_BEARERS_UPDATE_IND_MSG>(cmBearerGenericMessage));
    SCmBearersUpdateIndMsg const& cmBearerMsg(cmBearerMessage.getStaticPayloadReference());
    log("loop For all transport bearers in the procedure");
    for (unsigned int connection = 0; connection < cmBearerMsg.numConnections; connection++) {
        SpecificStaticMessage<MessageName::TUP_TRANSPORT_CONNECTION_RELEASE_REQ_MSG> specificMessage;
        TUP_TransportConnectionReleaseReq& payload(specificMessage.getStaticPayloadReference());
        SCmBearersUpdateIndDynamicPart const& dynamicPart(
            cmBearerMessage.getDynamicPayloadReferenceAtAndCreateIfNeeded(connection));
        payload.fpSicAddress = dynamicPart.fpSicAddress;
        payload.localPort = dynamicPart.localPort;
        send(ComponentName::Dsp, convertSpecificStaticToGeneric(specificMessage));
...
void TupcTbm::sendTransportConnectionReleaseReqsBasedOnReallocationCleanupReqMsg(
    ...
    SpecificStaticMessage<MessageName::TC_TRANSPORT_BEARER_REALLOCATION_CLEANUP_REQ_MSG> tbReallocationCleanupMessage(
        convertGenericToSpecificStatic<MessageName::TC_TRANSPORT_BEARER_REALLOCATION_CLEANUP_REQ_MSG>(
            tbReallocationCleanupGenericMessage));
    // STransportBearerReallocationCleanupReq const&
    // tbReallocationCleanupPayload(tbReallocationCleanupMessage.getStaticPayloadReference());
    log("loop For all transport bearers in the procedure");
...
void TupcTbm::sendTransportConnectionTransferReqsBasedOnReallocationPrepareReqMsg(
    GenericMessage const& tbReallocationPrepareGenericMessage) const {
    SpecificDynamicArrayMessage<MessageName::TC_TRANSPORT_BEARER_REALLOCATION_PREPARE_REQ_MSG>
        tbReallocationPrepareMessage(
            convertGenericToSpecificDynamicArray<MessageName::TC_TRANSPORT_BEARER_REALLOCATION_PREPARE_REQ_MSG>(
                tbReallocationPrepareGenericMessage));
    STransportBearerReallocationPrepareReq const& tbReallocationPreparePayloadMsg(
        tbReallocationPrepareMessage.getStaticPayloadReference());
    log("loop For all transport bearers in the procedure");
    for (unsigned int connection = 0; connection < tbReallocationPreparePayloadMsg.numConnections; connection++) {
        ...
        // STransportBearerReallocationData const&
        // dynamicPart(tbReallocationPrepareMessage.getDynamicPayloadReferenceAtAndCreateIfNeeded(connection));
