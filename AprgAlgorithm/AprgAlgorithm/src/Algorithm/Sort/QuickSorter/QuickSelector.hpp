...
public:
    ...
    QuickSelector(PivotType const pivotType)
...
// The idea in QuickSelect is not to do complete quicksort, but stop at the point where pivot itself is k’th smallest element.
