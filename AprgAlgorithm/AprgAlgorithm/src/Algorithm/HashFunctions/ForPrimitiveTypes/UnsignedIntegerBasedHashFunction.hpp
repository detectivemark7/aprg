...
public:
    ...
    static HashValue getHashCode(Input const& input) { return static_cast<HashValue>(input); }
...
// -> Each table index equally likely for each key (thoroughly researched problem, still problematic in practical
// applications)
