...
protected:
    ...
    void relaxAt(
        Vertex const& vertex,
        AdditionalRelaxationStepsWithNewWeight const& additionalRelaxationStepsWithNewWeight =
            getNoStepsWithNewWeight(),
        ...
        for (Vertex const& adjacentVertex : m_graph.getAdjacentVerticesAt(vertex)) {
            ...
            if (hasNoWeightSaved(adjacentVertex) ||
                ...
                m_vertexToEdgeWithBestWeightMap[adjacentVertex] =
                    EdgeOrderedByWeight(vertex, adjacentVertex, newWeight);
