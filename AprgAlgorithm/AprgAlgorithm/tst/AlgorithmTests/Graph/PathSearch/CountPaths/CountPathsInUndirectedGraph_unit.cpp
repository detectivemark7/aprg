...
TEST(CountPathsInUndirectedGraphTest, GetCountWorksOnExample1) {
    ...
    EXPECT_EQ(3, countPaths.getCount(1, 4));
    EXPECT_EQ(3, countPaths.getCount(1, 5));
    EXPECT_EQ(3, countPaths.getCount(1, 2));
    EXPECT_EQ(4, countPaths.getCount(1, 3));
    EXPECT_EQ(4, countPaths.getCount(1, 6));
    EXPECT_EQ(3, countPaths.getCount(5, 1));
    EXPECT_EQ(3, countPaths.getCount(5, 4));
    EXPECT_EQ(1, countPaths.getCount(5, 5));
    EXPECT_EQ(3, countPaths.getCount(5, 2));
