...
TEST(UnorderedLinkedListSetTest, IsEmptyWorksWhenEmpty)
{
...
TEST(UnorderedLinkedListSetTest, DoesContainWorks)
{
    testDoesContainWithUnsignedIntAndChar<SetForTest>();
}

TEST(UnorderedLinkedListSetTest, GetSizeWorksWhenEmpty)
{
...
TEST(UnorderedLinkedListSetTest, GetWorks)
{
    testGetWithUnsignedIntAndChar<SetForTest>();
}

TEST(UnorderedLinkedListSetTest, GetRankWorks)
{
    testGetRankWithUnsignedIntAndChar<SetForTest>();
}

TEST(UnorderedLinkedListSetTest, GetMinimumWorks)
{
    testGetMinimumWithUnsignedIntAndChar<SetForTest>();
}

TEST(UnorderedLinkedListSetTest, GetMaximumWorks)
{
    testGetMaximumWithUnsignedIntAndChar<SetForTest>();
}

TEST(UnorderedLinkedListSetTest, SelectAtWorks)
{
    testSelectAtWithUnsignedIntAndChar<SetForTest>();
}

TEST(UnorderedLinkedListSetTest, GetFloorWorks)
{
    testGetFloorWithUnsignedIntAndChar<SetForTest>();
}

TEST(UnorderedLinkedListSetTest, GetCeilingWorks)
{
    testGetCeilingWithUnsignedIntAndChar<SetForTest>();
}

TEST(UnorderedLinkedListSetTest, PutWorks)
{
    testPutWithUnsignedIntAndChar<SetForTest>();
}

TEST(UnorderedLinkedListSetTest, DeleteBasedOnKeyWorks)
{
    testDeleteBasedOnKeyWithUnsignedIntAndChar<SetForTest>();
}

TEST(UnorderedLinkedListSetTest, DeleteMinimumWorks)
{
    testDeleteMinimumWithUnsignedIntAndChar<SetForTest>();
}

TEST(UnorderedLinkedListSetTest, DeleteMaximumWorks)
{
    testDeleteMaximumWithUnsignedIntAndChar<SetForTest>();
}

TEST(UnorderedLinkedListSetTest, GetKeys)
{
