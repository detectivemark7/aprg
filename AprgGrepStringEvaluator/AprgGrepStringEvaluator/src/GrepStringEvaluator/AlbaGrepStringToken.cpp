...
AlbaGrepStringToken::AlbaGrepStringToken()
    : m_type(TokenType::Dummy)
    , m_operatorType(AlbaGrepStringOperatorType::Unknown)
    , m_string()
{}

AlbaGrepStringToken::AlbaGrepStringToken(string const& stringToFind)
    : m_type(TokenType::StringToFind)
    , m_operatorType(AlbaGrepStringOperatorType::Unknown)
    , m_string(stringToFind)
{}
...
AlbaGrepStringToken::AlbaGrepStringToken(AlbaGrepStringOperatorType const operatorType, std::string const& operatorString)
    : m_type(TokenType::Operator)
    , m_operatorType(operatorType)
    , m_string(operatorString)
{}
...
bool AlbaGrepStringToken::isOperator() const
{
    return TokenType::Operator == m_type;
}
...
bool AlbaGrepStringToken::isString() const
{
    return TokenType::StringToFind == m_type;
}
...
AlbaGrepStringToken::TokenType AlbaGrepStringToken::getTokenType() const
{
    return m_type;
}

AlbaGrepStringOperatorType AlbaGrepStringToken::getOperatorType() const
{
...
void AlbaGrepStringToken::appendToString(char const character)
{
    m_string += character;
}
